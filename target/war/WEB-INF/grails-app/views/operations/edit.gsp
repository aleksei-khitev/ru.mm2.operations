	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="index"><g:message code="default.listoperation.label" args="[entityName]" /></g:link></li>
				<li><g:link class="create" action="create"><g:message code="default.newoperation.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
