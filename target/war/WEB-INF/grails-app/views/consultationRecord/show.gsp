...
<div id="show-consultationRecord" class="content scaffold-show" role="main">
    ...
    <ol class="property-list consultationRecord">
        ...
        <g:if test="${consultationRecordInstance?.birthday}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="birthday-label"><g:formatDate format="dd.MM.yyyy" date="${consultationRecordInstance?.birthday}" /></span>
        ...
        <g:if test="${consultationRecordInstance?.date_time}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="date_time-label"><g:formatDate format="dd.MM.yyyy" date="${consultationRecordInstance?.date_time}" /></span>
    ...
    <g:form url="[resource:consultationRecordInstance, action:'delete']" method="DELETE">
        <fieldset class="buttons">
            ...
            <g:link class="edit" controller="operationRecord" action="create" params='[doctor_id:"${consultationRecordInstance?.doctor?.id}",oms:"${consultationRecordInstance?.oms}",birthday:"${consultationRecordInstance?.birthday}",client_contact:"${consultationRecordInstance?.client_contact}",diagnoz:"${consultationRecordInstance?.diagnoz}",fio:"${consultationRecordInstance?.fio}",from_consult:"true",date_time: "${consultationRecordInstance?.date_time}"]' style="color: maroon; font-weight: bold;"><g:message code="default.consulttooper.label" default="Направить на операцию"/></g:link>
