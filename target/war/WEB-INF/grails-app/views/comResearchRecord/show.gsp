			...
			<ol class="property-list comResearchRecord">
				...
				<li class="fieldcontain">
					<span id="research-label" class="property-label"><g:message code="comResearchRecord.research.label" default="исследование" /></span>
						...
						<span class="property-value" aria-labelledby="research-label"><g:link controller="research" action="show" id="${comResearchRecordInstance?.research?.id}">${comResearchRecordInstance?.research?.name}</g:link></span>
