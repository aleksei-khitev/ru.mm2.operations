			...
			<g:form url="[resource:comResearchRecordInstance, action:'save']" >
				<fieldset class="form">
                    ...
                    <div class="fieldcontain ${hasErrors(bean: comResearchRecordInstance, field: 'research', 'error')} required">
                        ...
                        <g:select id="research" name="research.id" from="${ru.mm2.operations.Research.list()}" optionValue="name" optionKey="id" required="" value="${comResearchRecordInstance?.research?.id}" class="many-to-one"/>
                    </div>
				</fieldset>
        ...
        <table>
            ...
            <g:each in="${comResearchRecordInstanceList}" status="i" var="comResearchRecordInstance">
                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                        ...
                        <td>"${comResearchRecordInstance?.research?.name }"</td>
