	...
	<body>
		...
		<div class="nav" role="navigation" style="background-color: #FA8072">
			<ul>
				...
				<li><g:link class="list" action="index" style="color: white"><g:message code="default.listrecod.label" args="[entityName]" /></g:link></li>
				<li><g:link class="create" action="create" style="color: white"><g:message code="default.newrecod.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
