...
YAHOO.lang.extend(GRAILSUI.DataTable, YAHOO.widget.DataTable, {
    ...
    // provides custom user filtering
    addFilter: function(userFilterBy, userFilterOn) {
        this.userFilters[userFilterBy] = userFilterOn;
        this.requery();
    },
    
    // clear one filter
    clearFilter: function(userFilterBy) {
        delete this.userFilters[userFilterBy];
        this.requery();
    },

    // clears all filters
    clearFilters: function(userFilterBy, userFilterOn) {
        this.userFilters = {};
        this.requery();
    },
    
    // builds a new state and requeries
    requery: function() {
        this.loadingDialog.show();
        var sortedBy  = this.get('sortedBy');
        // Define the new state
