...
class gsp_operations_operationRecordindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/operationRecord/index.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(3, {->
printHtmlPart(10)
if(true && (ru.mm2.operations.OperationRecordController.isSanday(new Date()+i))) {
printHtmlPart(11)
...
for( i in ((0..<120)) ) {
printHtmlPart(16)
for( v in (ru.mm2.operations.OperationRecordController.collectPatologies(new Date()+i)) ) {
printHtmlPart(17)
expressionOut.print(resource(dir: 'images', file: 'type2.png'))
printHtmlPart(18)
}
printHtmlPart(10)
for( v in (ru.mm2.operations.OperationRecordController.collectLessTreeYears(new Date()+i)) ) {
printHtmlPart(17)
expressionOut.print(resource(dir: 'images', file: 'type1.png'))
printHtmlPart(19)
}
printHtmlPart(10)
for( v in (ru.mm2.operations.OperationRecordController.collectOthers(new Date()+i)) ) {
printHtmlPart(17)
...
public static final long LAST_MODIFIED = 1389197460000L
