...
class gsp_operations_consultationRecordedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/consultationRecord/edit.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',36,['name':("version"),'value':(consultationRecordInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',43,['url':([resource:consultationRecordInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1389540035000L
