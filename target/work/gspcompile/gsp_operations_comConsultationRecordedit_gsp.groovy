...
class gsp_operations_comConsultationRecordedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/comConsultationRecord/edit.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(19)
invokeTag('hiddenField','g',36,['name':("version"),'value':(comConsultationRecordInstance?.version)],-1)
printHtmlPart(20)
...
invokeTag('form','g',43,['url':([resource:comConsultationRecordInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1389539992000L
