...
class gsp_operations_doctoredit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/doctor/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'doctor.label', default: 'Doctor'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
printHtmlPart(7)
createTagBody(2, {->
invokeTag('message','g',19,['code':("default.listdoctor.label"),'args':([entityName])],-1)
})
invokeTag('link','g',19,['class':("list"),'action':("index"),'style':("color: black")],2)
printHtmlPart(8)
createTagBody(2, {->
invokeTag('message','g',20,['code':("default.newdoctor.label"),'args':([entityName])],-1)
})
invokeTag('link','g',20,['class':("create"),'action':("create"),'style':("color: black")],2)
printHtmlPart(9)
invokeTag('message','g',24,['code':("default.editdoctor.label"),'args':([entityName])],-1)
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1389544550000L
