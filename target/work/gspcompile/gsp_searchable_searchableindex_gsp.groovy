...
@GrailsPlugin(name='searchable', version='0.6.5')
class gsp_searchable_searchableindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/searchable-0.6.5/grails-app/views/searchable/index.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1380705404000L
