...
class gsp_operations_comConsultationRecordindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/comConsultationRecord/index.gsp" }
public Object run() {
Writer out = getOut()
...
for( i in ((0..<120)) ) {
printHtmlPart(8)
if(true && (ru.mm2.operations.ComConsultationRecordController.isSanday(new Date()+i))) {
printHtmlPart(9)
...
for( i in ((0..<120)) ) {
printHtmlPart(14)
for( v in (ru.mm2.operations.ComConsultationRecordController.collectLessTreeYears(new Date()+i)) ) {
printHtmlPart(15)
expressionOut.print(resource(dir: 'images', file: 'type1.png'))
printHtmlPart(16)
}
printHtmlPart(17)
for( v in (ru.mm2.operations.ComConsultationRecordController.collectOthers(new Date()+i)) ) {
printHtmlPart(15)
...
public static final long LAST_MODIFIED = 1389197367000L
