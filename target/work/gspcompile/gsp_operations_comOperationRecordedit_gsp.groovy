...
class gsp_operations_comOperationRecordedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/comOperationRecord/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',32,['bean':(comOperationRecordInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',34,['bean':(comOperationRecordInstance)],2)
printHtmlPart(1)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('hiddenField','g',36,['name':("version"),'value':(comOperationRecordInstance?.version)],-1)
printHtmlPart(20)
...
invokeTag('form','g',43,['url':([resource:comOperationRecordInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1389539976000L
