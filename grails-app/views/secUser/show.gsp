...
<html>
	<head>
		...
		<title><g:message code="default.showuser.label" args="[entityName]" /></title>
        <script>
	...
	<body>
		...
		<div id="show-secUser" class="content scaffold-show" role="main">
			<h1><g:message code="default.showuser.label" args="[entityName]" /></h1>
			...
			<ol class="property-list secUser">
                ...
                <g:if test="${secUserInstance?.fullName}">
                    <li class="fieldcontain">
                        <span id="fullName-label" class="property-label"><g:message code="secUser.fullName.label" default="Видимое имя пользователя" /></span>
				...
				<li class="fieldcontain">
					<span id="username-label" class="property-label"><g:message code="secUser.username.label" default="Имя для входа в систему" /></span>
				...
				<li class="fieldcontain">
					<span id="accountExpired-label" class="property-label"><g:message code="secUser.accountExpired.label" default="Account Expired" /></span>
						...
						<span class="property-value" aria-labelledby="accountExpired-label"><g:formatBoolean true="Да" false="Нет" boolean="${secUserInstance?.accountExpired}" /></span>
				...
				<li class="fieldcontain">
					<span id="accountLocked-label" class="property-label"><g:message code="secUser.accountLocked.label" default="Account Locked" /></span>
						...
						<span class="property-value" aria-labelledby="accountLocked-label"><g:formatBoolean true="Да" false="Нет" boolean="${secUserInstance?.accountLocked}" /></span>
				...
				<li class="fieldcontain">
					<span id="enabled-label" class="property-label"><g:message code="secUser.enabled.label" default="Активность" /></span>
					
						<span class="property-value" aria-labelledby="enabled-label"><g:formatBoolean true="Да" false="Нет" boolean="${secUserInstance?.enabled}" /></span>
				...
				<li class="fieldcontain">
					<span id="passwordExpired-label" class="property-label"><g:message code="secUser.passwordExpired.label" default="Password Expired" /></span>
						...
						<span class="property-value" aria-labelledby="passwordExpired-label"><g:formatBoolean true="Да" false="Нет" boolean="${secUserInstance?.passwordExpired}" /></span>

				</li>
				</g:if>


                <g:if test="${secUserInstance?.authorities}">
                    <li class="fieldcontain">
                        <span id="authorities-label" class="property-label"><g:message code="secUser.authorities.label" default="Роли" /></span>
