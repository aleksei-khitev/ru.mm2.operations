...
<html>
	<head>
		...
		<title><g:message code="default.createrole.label" args="[entityName]" /></title>
	</head>
	<body>
		...
		<div id="create-secUserSecRole" class="content scaffold-create" role="main">
			<h1><g:message code="default.createrole.label" args="[entityName]" /></h1>
			...
			<g:form url="[resource:secUserSecRoleInstance, action:'save']" >
				<fieldset class="form">
