...
<html>
	<head>
		...
		<title><g:message code="default.editrole.label" args="[entityName]" /></title>
	</head>
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="index"><g:message code="default.listrole.label" args="[entityName]" /></g:link></li>
				<li><g:link class="create" action="create"><g:message code="default.newrole.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="edit-secUserSecRole" class="content scaffold-edit" role="main">
			<h1><g:message code="default.editrole.label" args="[entityName]" /></h1>
			...
			<g:form url="[resource:secUserSecRoleInstance, action:'update']" method="PUT" >
