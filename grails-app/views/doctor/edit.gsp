	...
	<body>
		...
		<div class="nav" role="navigation" style="background-color: sandybrown">
			<ul>
				...
				<li><g:link class="list" action="index" style="color: black"><g:message code="default.listdoctor.label" args="[entityName]" /></g:link></li>
				<li><g:link class="create" action="create" style="color: black"><g:message code="default.newdoctor.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="edit-doctor" class="content scaffold-edit" role="main">
			<h1><g:message code="default.editdoctor.label" args="[entityName]" /></h1>
